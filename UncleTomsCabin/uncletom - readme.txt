uncletom.rb its ein Ruby script, welches aus der PDF Datei die buchtitel_zwischen.xml Datei erstellt.
...
2. Script ausführen mit:
	...
	ruby uncletom.rb -f "Dateiname"


Das Script benötigt die Argumente "-f" gefolgt von dem Dateinamen der Ausgangs-Datei (uncle_toms_cabin.pdf).
...
Das script speichert dann das Ergebnis in der Datei "uncletom_zwischen.xml" im selben Ordner.
