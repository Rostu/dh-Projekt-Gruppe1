huck.rb its ein Ruby Skript, welches aus der PDF Datei die buchtitel_zwischen.xml Datei erstellt.
...
1. In der Konsole in den Ordner des Skripts navigieren
2. Skript ausführen mit:

	ruby huck.rb -f "Dateiname"

Das Script benötigt die Argumente "-f" gefolgt von dem Dateinamen der Ausgangs-Datei ("HuckFinn_Gutenberg.txt").
...
Das script speichert dann das Ergebnis in der Datei "HuckleberryFinn_zwischen.xml" im selben Ordner.
